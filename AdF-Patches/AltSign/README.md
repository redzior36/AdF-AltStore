...
- upstream and controlled regression-test blob: `d94eea268b203c93082260c201e3840dcfe96fcd`
...
The vendored Python regression harness is byte-for-byte identical to the upstream 17-scenario harness at the pinned PR head. The applicator fail-closes unless both the production Swift result and regression harness match their exact upstream blobs.
